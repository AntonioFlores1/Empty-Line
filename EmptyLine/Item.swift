...
struct Item: Codable {
    ...
    init(name: String, barcode: String, description: String, ingredients: String, image: String, price: Double, isCoupon: Bool , coupon: Double, itemID: String, boughtDate: String) {
        self.itemID = itemID
        self.name = name
